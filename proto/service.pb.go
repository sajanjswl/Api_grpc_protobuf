...
var fileDescriptor_a0b84a42fa06f626 = []byte{
	...
	0x8a, 0x1f, 0xce, 0x87, 0x9a, 0xa6, 0xcd, 0xc5, 0xe1, 0x5b, 0x5a, 0x92, 0x93, 0x59, 0x52, 0x50,
	0x49, 0x50, 0x71, 0x12, 0x1b, 0x98, 0x6f, 0x0c, 0x08, 0x00, 0x00, 0xff, 0xff, 0x68, 0x73, 0x67,
	0x57, 0xcc, 0x00, 0x00, 0x00,
}
...
type AddServiceClient interface {
	...
	Mutlitpy(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error)
}
...
func (c *addServiceClient) Mutlitpy(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, "/proto.AddService/Mutlitpy", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AddServiceServer interface {
	...
	Mutlitpy(context.Context, *Request) (*Response, error)
}
...
func (*UnimplementedAddServiceServer) Mutlitpy(ctx context.Context, req *Request) (*Response, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Mutlitpy not implemented")
}
...
func _AddService_Mutlitpy_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Request)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AddServiceServer).Mutlitpy(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.AddService/Mutlitpy",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AddServiceServer).Mutlitpy(ctx, req.(*Request))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _AddService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "Mutlitpy",
			Handler:    _AddService_Mutlitpy_Handler,
		},
	},
